...
interface details{
	public void display(String name,int rollno,String dept,int year) ;
	
	}
interface total{
	public void totalmark(int a,int b,int c,int d,int e);
	
}
	class Studen_t implements details,total{
